    ...
    <div style={{
        ...
        >
          ...
          <motion.button
            ...
            style={{
              ...
              left: 16,
              zIndex: 200,
              background: C.isDark ? 'rgba(0,0,0,0.55)' : 'rgba(255,255,255,0.85)',
        ...
        {showDetailPanel && activeItem && (
          <>
            ...
            <motion.div
              ...
              style={{ position: 'fixed', inset: 0, zIndex: 148, background: C.isDark ? 'rgba(0,0,0,0.5)' : 'rgba(255,255,255,0.4)' }}
            />
            <motion.div
              initial={{ y: '100%' }}
              animate={{ y: 0 }}
      ...
      <AnimatePresence>
        {showShareMenu && (
          <motion.div
            initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            style={{ position: 'fixed', inset: 0, background: C.isDark ? 'rgba(0,0,0,0.82)' : 'rgba(255,255,255,0.88)', backdropFilter: 'blur(8px)', WebkitBackdropFilter: 'blur(8px)', zIndex: 300, display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}
