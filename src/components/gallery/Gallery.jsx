                ...
                return (
                  <div key={idol.id} style={{display:'flex',flexDirection:'column',alignItems:'center',gap:5}}>
                    <motion.div animate={{opacity:hovered===idol.id?1:0,y:hovered===idol.id?0:4}}
                      style={{...ff.body,fontSize:7,letterSpacing:'.2em',color:C.text,whiteSpace:'nowrap',background:C.isDark?'rgba(0,0,0,0.8)':'rgba(255,255,255,0.9)',padding:'3px 8px',borderRadius:4,border:`1px solid ${C.border}`,pointerEvents:'none',marginBottom:2}}>
                      {idol.deity}
                    </motion.div>
              ...
              >
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    background:C.isDark?'rgba(0,0,0,0.68)':'rgba(255,255,255,0.85)',backdropFilter:'blur(12px)',
