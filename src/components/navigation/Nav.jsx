...
const Nav = ({ scrolled }) => {
  ...
  const navCards = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Visiting Card', id: 'visiting-card' },
      ]
    },
    {
      label: 'Connect',
      bg: '#181218',
      links: [
        { label: 'Client Reviews', id: 'client-reviews' },
        { label: 'FAQ', id: 'faq' },
  ...
  // Dark theme only backgrounds
  const navBg = scrolled ? 'rgba(8,6,4,0.75)' : 'transparent';
  const pillBg = 'rgba(17,14,10,0.70)';
  const sepColor = 'rgba(255,215,0,0.12)';
  ...
  return (
    <>
      ...
      <motion.div
        ...
        <motion.div
          ref={menuRef}
          whileHover={{ y: -1, boxShadow: '0 8px 48px rgba(0,0,0,.75), 0 0 0 1px rgba(255,215,0,0.28), 0 0 32px rgba(255,215,0,0.07)' }}
          ...
          style={{
            ...
            borderRadius: 16,
            boxShadow: '0 4px 40px rgba(0,0,0,.7), 0 0 0 1px rgba(255,215,0,0.10), inset 0 1px 0 rgba(255,255,255,0.04)',
            overflow: 'hidden',
            position: 'relative',
