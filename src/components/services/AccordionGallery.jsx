...
const CRAFT_PANELS = [
  {
    id: 'panchaloha',
    title: 'Panchaloha Casting',
    subtitle: 'Lost-Wax Casting',
    metal: 'Panchaloha',
    img: '/gallery/temple/god.jpg',
    description: 'Traditional lost-wax casting for Panchaloha vigrahams, shaped with attention to form, proportion and traditional iconographic detail.',
  },
  {
    id: 'gold-naga',
    title: '24K Gold Naga Work',
    subtitle: 'Sacred Repoussé',
    metal: '24K Gold',
    img: '/gallery/gold/crown.jpg',
    description: 'Handcrafted repoussé work in 24K gold for traditional temple applications and ornamental detailing.',
  },
  {
    id: 'silver-articles',
    title: 'Silver Sanctum Articles',
    subtitle: 'Sanctum & Ritual Ware',
    metal: 'Silver',
    img: '/gallery/silver/kandabaranam.jpg',
    description: 'Silver articles crafted for temple sanctums, rituals and traditional ceremonial use.',
  },
  {
    id: 'kireedams',
    title: 'Kireedams & Temple Regalia',
    subtitle: 'Ornamental Crowns',
    metal: 'Gold & Silver',
    img: '/gallery/gold/crown1.jpg',
    description: 'Ornamental crowns and ceremonial metalwork created for temple deities and traditional occasions.',
  },
  {
    id: 'architectural',
    title: 'Architectural Metalwork',
    subtitle: 'Sanctum & Temple Elements',
    metal: 'Copper & Brass',
    img: '/gallery/stone/stone2.jpg',
    description: 'Bespoke metal elements for temple interiors, sanctums and architectural spaces.',
  },
];
