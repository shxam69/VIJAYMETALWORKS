      ...
      <div className="vmw-container">
        ...
        <Reveal>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            >
              Handcrafted temple metalwork shaped with attention to proportion, detail and traditional craftsmanship.
            </p>
          </div>
        </Reveal>
        ...
        <div style={{ marginTop: 64, paddingTop: 48, borderTop: `1px solid ${C.border}` }}>
          ...
          <AnimatePresence mode="wait">
            ...
            >
                <div style={{ position: 'relative', overflow: 'hidden', minHeight: 'clamp(200px,30vw,340px)', display: 'flex', alignItems: 'flex-end' }}>
                <img
                  src={getImage(m.imageId, m.img)}
                  alt={m.name}
                  style={{
                    position: 'absolute',
                    inset: 0,
                ...
                />
                <div style={{ position: 'relative', zIndex: 2, padding: 'clamp(20px, 5vw, 32px)', width: '100%' }}>
                  <div style={{ fontSize: 'clamp(28px, 8vw, 32px)', marginBottom: 8, lineHeight: 1 }}>{m.icon}</div>
                  <div
                    style={{
                      ...ff.display,
              ...
              <div className="vmw-services-right" style={{ padding: 'clamp(20px,3.5vw,40px)', display: 'flex', flexDirection: 'column' }}>
                {m.services.map((s, i) => (
                  ...
                  >
                    <div style={{ display: 'flex', gap: 'clamp(12px, 2.5vw, 16px)', alignItems: 'flex-start' }}>
                      <span
                        style={{
                          ...ff.body,
                          fontSize: 9,
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ ...ff.body, fontSize: 'clamp(11px, 2.5vw, 12px)', lineHeight: 1.8, color: C.dim, fontWeight: 300 }}>
                          {s.d}
                        </div>
                      </div>
                    </div>
