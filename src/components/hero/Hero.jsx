      ...
      <motion.div
        style={{
          ...
          filter: C.isDark 
            ...
            : 'brightness(0.65) contrast(1.1) saturate(0.95)',
        }}
      />

      {/* Atmospheric gradient overlays - theme aware */}
      <div
        style={{
          position: 'absolute',
          inset: 0,
          zIndex: 2,
          background: C.isDark 
            ? 'radial-gradient(ellipse 80% 60% at 50% 45%, rgba(10,8,6,0.3) 0%, rgba(8,6,4,0.85) 75%, #080604 100%)'
            : 'radial-gradient(ellipse 80% 60% at 50% 45%, rgba(245,240,232,0.15) 0%, rgba(245,240,232,0.6) 75%, rgba(245,240,232,0.85) 100%)',
        }}
      />
      <div
        style={{
          ...
          zIndex: 2,
          background: C.isDark
            ? 'linear-gradient(to bottom, rgba(8,6,4,0.6) 0%, transparent 25%, rgba(8,6,4,0.8) 80%, #080604 100%)'
            : 'linear-gradient(to bottom, rgba(245,240,232,0.3) 0%, transparent 25%, rgba(245,240,232,0.55) 80%, rgba(245,240,232,0.75) 100%)',
        }}
      />
