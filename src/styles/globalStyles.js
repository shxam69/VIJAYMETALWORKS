...
body{background:${C.bg1};color:${C.text};font-family:'Jost',sans-serif;overflow-x:hidden;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;transition:background .35s,color .35s;position:relative;min-height:100vh}
...
@media(max-width:1024px){
  ...
  .vmw-temples-grid{grid-template-columns:repeat(3,1fr)!important}
...
@media(max-width:900px){
  ...
  /* Process mobile override - stack image above text */
  .vmw-process-grid{grid-template-columns:1fr!important;gap:20px!important}
  .vmw-process-img{order:-1!important;width:100%!important;max-width:100%!important;display:block!important;aspect-ratio:4/3!important}
  .vmw-process-img img{width:100%!important;height:100%!important;min-height:240px!important;object-fit:cover!important}
  .vmw-process-content{order:2!important}
...
@media(max-width:480px){
  ...
  .vmw-temples-grid{grid-template-columns:1fr!important}
  .archive-grid{grid-template-columns:1fr!important}
  .vmw-footer-btns{grid-template-columns:1fr!important}
  ...
  .vmw-container{padding-left:16px!important;padding-right:16px!important}
  
  /* Reduce section padding on very small screens */
  .section-pad{padding-top:clamp(40px,8vw,60px)!important;padding-bottom:clamp(40px,8vw,60px)!important}
  
  /* Gallery masonry mobile */
  .gallery-masonry{columns:1!important;column-gap:0!important}
  
  /* Testimonials mobile */
  .vmw-featured-testimonial{padding:20px 16px!important}
  
  /* Process mobile compact */
  .vmw-process-grid{grid-template-columns:1fr!important;gap:18px!important}
  .vmw-process-img{min-height:220px!important}
  .vmw-process-img img{min-height:220px!important}
  .vmw-process-content{padding-left:0!important;padding-right:0!important}
}
